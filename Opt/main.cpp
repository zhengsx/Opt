...
void usage(const char* prog)
{
    ...
    cout << "-tr <file> Training file to classify" << endl;
    cout << "-te <file>  Test file to classify " << endl;
    ...
    cout << "-mb        minibatchsize" << endl << endl;
...
MatrixXd computelogisticgradient(MatrixXd weights, SparseMatrix<double> data, MatrixXd label, double l2) {
